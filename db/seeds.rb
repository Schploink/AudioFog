...
s4 = Sound.create(description: "Moody electronic synthcloud from SFs respected upstart", uploader_id: u3.id)
s5 = Sound.create(description: "Moody electronic synthcloud from Austin", uploader_id: u6.id)
