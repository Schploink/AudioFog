...
s3 = Sound.create(description: "Modern dancefloor classic", uploader_id: u3.id)
s4 = Sound.create(description: "Latest from Deetron", uploader_id: u5.id)
s5 = Sound.create(description: "Composed ambient pleasure", uploader_id: u6.id)
s6 = Sound.create(description: "Classics from an original RIP", uploader_id: u7.id)
s7 = Sound.create(description: "Emotional vocal beast", uploader_id: u8.id)
s8 = Sound.create(description: "Beach house vibezzzz", uploader_id: u9.id)
s9 = Sound.create(description: "Latest from Prins Thomas", uploader_id: u10.id)
s10 = Sound.create(description: "DANG THIS TRACKKKKK", uploader_id: u11.id)
s11 = Sound.create(description: "In tha system", uploader_id: u1.id)
s12 = Sound.create(description: "Recently unearthed queer classic", uploader_id: u13.id)
s13 = Sound.create(description: "Collab with Alessandro Cortini", uploader_id: u4.id)
s14 = Sound.create(description: "German Engineering", uploader_id: u12.id)
